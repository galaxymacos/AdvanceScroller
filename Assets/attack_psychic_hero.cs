...
public class attack_psychic_hero : StateMachineBehaviour
{
    ...
    public override void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        spawnTransform = animator.transform.Find("SpawnLocations").Find("Sword");
    }
    ...
    {
        GameObject knife = Instantiate(knifePrefab, spawnTransform.position, Quaternion.identity);
        // knife.GetComponent<Sword>().moveRight = 
    }
}
